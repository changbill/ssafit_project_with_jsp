		...
		<div class="main-flex-container d-flex w-100">
			...
			<div class="review-rightside px-3">
				...
				<div class="review-rightside-list ">
					<ul class="review-item-list-ul d-flex align-items-center" data-bs-toggle="collapse"
						...
						<table style="margin-top:190px" >
							...
							<c:forEach items="${reviewList }" var="review">
								<tr>
									...
									<td>${review.regDate }</td>
									<td>
									<a href="main?act=reviewUpdateForm&reviewId=${review.reviewId }"><button type="button"
										class="btn btn-outline-danger btn-sm">리뷰 수정</button></a>
									</td>
									<td>	 <a
									href="main?act=deleteReview&reviewId=${review.reviewId }"><button type="button"
					...
					<!-- <div class="collapse collap" id="collapseExample">
						<div class="card card-body">
							<div class="card-content d-flex">
								...
								<div class="card-right">ìì ë³´ê³  ìì²´ë
									ì»¤ì¡ìµëë¤</div>
							</div>
