            ...
            <div class="main-form">
               <div class="form-upside border-bottom border-info-subtle border-2 pt-2">
                    <div class="mb-3 w-100 max-vw-100">
                        ...
                        <input type="text" class="form-control" id="review-title" placeholder="이름을 작성해주세요.">
                    </div>
                    <div class="mb-3 w-100">
                        <label for="review-content" class="form-label">&nbsp;작성 내용</label>
                        <textarea class="form-control" id="review-content" rows="4" style="resize: none;" placeholder="내용을 작성해주세요."></textarea>
                    </div>
                    <!-- <form class="" >
                ...
                pt-3">
                    <a href="main?act=reviewList"><button type="submit" class="btn btn-outline-primary mx-3">등록하기</button></a>
