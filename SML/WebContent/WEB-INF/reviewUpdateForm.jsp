            ...
            <div class="main-form">
                <div class="form-upside border-bottom border-info-subtle border-2 pt-2">
                    <div class="mb-3 w-100 max-vw-100">
                        ...
                        <input type="text" class="form-control" id="review-title" placeholder="작성자의 이름을 작성하세요." name = "title" value="${review.writer }">
                    </div>
                    <div class="mb-3 w-100">
                        <label for="review-content" class="form-label">&nbsp;작성 내용</label>
                        <textarea class="form-control" id="review-content" rows="4" style="resize: none;" placeholder="작성내용을 써주세요.">${review.title }</textarea>
                    </div>
                    <!-- <form class="" >
                ...
                pt-3">
                    <a href="main?act=reviewList"><button type="submit" class="btn btn-outline-danger mx-3">등록하기</button></a>
