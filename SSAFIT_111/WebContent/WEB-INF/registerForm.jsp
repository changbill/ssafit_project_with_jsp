                ...
                <div class="window-register">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="btn-group"  role="group" aria-label="Basic example">
                        	<!--  -->
                            <a href="main?act=index"><button type="button" class="btn btn-outline-primary">ê°ìíê¸°</button></a>
                            <a href="main?act=index"><button type="button" class="btn btn-outline-secondary">ì·¨ì</button></a>
                        </div>
                    </div>
                </div>
            </div>
