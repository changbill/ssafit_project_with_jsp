            ...
            <div class="main-form">
                <div class="form-upside border-bottom border-info-subtle border-2 pt-2">
                    <div class="mb-3 w-100 max-vw-100">
                        ...
                        <input type="text" class="form-control" id="review-title" placeholder="ë³ê²½í  ì ëª©ì ìë ¥í´ì£¼ì¸ì.">
                    </div>
                    <div class="mb-3 w-100">
                        <label for="review-content" class="form-label">&nbsp;ë´ ì© </label>
                        <textarea class="form-control" id="review-content" rows="4" style="resize: none;" placeholder="ë³ê²½í  ë´ì©ì ìì±í´ì£¼ì¸ì."></textarea>
                    </div>
                    <!-- <form class="" >
                ...
                pt-3">
                    <a href="main?act=reviewList"><button type="submit" class="btn btn-outline-danger mx-3">ìì </button></a>
